...
void setting_win_init(lv_obj_t* parent)
{
    ...
    //POSITION
    lv_obj_t* title = lv_label_create(setting_win, nullptr);
    lv_label_set_text(title, "\n\n\n[Postion]");
    lv_obj_t* cont_x = static_cast<lv_obj_t *>(tbox_create(setting_win, "X: "));
    lv_obj_t* cont_y = static_cast<lv_obj_t *>(tbox_create(setting_win, "Y: "));
    ...
    //SIZE
    title = lv_label_create(setting_win, nullptr);
    ...
    //DRAG && CLICK
    lv_obj_t* cb_drag = lv_cb_create(setting_win, nullptr);
    ...
    //SElECTED
    base_attr.obj_selected = lv_label_create(setting_win, nullptr);
