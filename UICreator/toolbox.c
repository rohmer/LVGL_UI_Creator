...
static void create_label_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        ...
        if(par == NULL) return;
        lv_obj_t * newObj = lv_label_create(par, NULL);
        if(last_widget != NULL)
        {
...
static void create_btn_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_btn_create(par, NULL);
...
static void create_cb_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_cb_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
...
static void create_ddlist_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_ddlist_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
...
static void create_bar_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_bar_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
...
static void create_led_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_led_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
...
static void create_gauge_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_gauge_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
...
static void create_slider_cb(lv_obj_t * obj, lv_event_t ev)
{
    ...
    if(ev == LV_EVENT_CLICKED)
    {
        lv_obj_t * par = layerview_get_sel_obj();
        if(par == NULL) return;
        lv_obj_t * newObj = lv_slider_create(par, NULL);
        if(last_widget != NULL)
        {
            lv_obj_set_pos(newObj, lv_obj_get_x(last_widget) + 10, lv_obj_get_y(last_widget) + 10);
        }
