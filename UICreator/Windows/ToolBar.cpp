...
void ToolBar::createVariableTools()
{
	...
	lv_obj_set_user_data(varNameTA, (lv_obj_user_data_t)this);
	lv_obj_set_event_cb(varNameTA, updateVariable);
	lv_obj_set_user_data(varHistTA, (lv_obj_user_data_t)this);
	lv_obj_set_event_cb(varHistTA, updateVariable);
	lv_obj_set_user_data(varDefaultValTA, (lv_obj_user_data_t)this);
	lv_obj_set_event_cb(varDefaultValTA, updateVariable);
	lv_obj_set_user_data(varDTDropDown, (lv_obj_user_data_t)this);
