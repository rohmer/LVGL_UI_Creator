...
namespace Serialization
{
    ...
    json Page::serializeObject(lv_obj_t* object)
    {
        ...
        {
            return Serialization::LVArc::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_bar") == 0)
        {
            return Serialization::LVBar::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_btn") == 0)
        {
            return Serialization::LVButton::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_btnm") == 0)
        {
            return Serialization::LVButtonMatrix::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_cal") == 0)
        {
            return Serialization::LVCalendar::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_canvas") == 0)
        {
            return Serialization::LVCanvas::ToJSON(object);
        }
        if (strcmp(objType->type[0], "lv_cb") == 0)
        {
            return Serialization::LVCheckBox::ToJSON(object);
        }
